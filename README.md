...
Quarkus Platform aggreagtes extensions from Quarkus Core and those developed by the community into a single tested, compatible and versioned set
...
`quarkus-platform-bom` should always be importing `io.quarkus:quarkus-bom:xxx` before anything other dependencies to make sure
